...
`GET /kb/*` и `GET /faq/*` (см. врезку ниже). Тело не нужно.
```json
...
> **Что открыто гостю:** список и содержимое статей базы знаний, вложения к ним, список вопросов FAQ. Всё остальное — чаты, заявки, проекты, ШУ, уведомления — требует полноценного входа.
>
...
Ручной запуск — `POST /admin/projects/{project_id}/sync-folder`, описан выше.
