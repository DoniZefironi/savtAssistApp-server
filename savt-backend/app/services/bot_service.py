...
# Явные глаголы-команды позвать оператора — сами по себе однозначны даже без
# слова "оператор" ("вызывай!" в ответ на предложение/после предыдущей
# просьбы оператора значит ровно то же самое, что "вызывай оператора")
