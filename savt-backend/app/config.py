...
class Settings(BaseSettings):
    ...
    # Номер проекта из Bitrix засчитывается, только если название сделки начинается
    # ровно с этого префикса + "_" (например "26_" — производственный год). Менять
    # на актуальный при смене года.
    bitrix_production_number_prefix: str = "26"
